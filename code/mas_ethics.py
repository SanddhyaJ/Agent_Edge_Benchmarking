...
# Define tools
@tool
def justice(q, choices : list[str]) -> str:
...
@tool
def beneficience(q, choices : list[str]) -> str:
...
@tool
def autonomy(q, choices : list[str]) -> str:
...
@tool
def non_maleficence(q, choices : list[str]) -> str:
