...
# Define tools
@tool
def justice(q : str, choices : list[str]) -> str:
...
@tool
def beneficience(q : str, choices : list[str]) -> str:
...
@tool
def autonomy(q : str, choices : list[str]) -> str:
...
@tool
def non_maleficence(q : str, choices : list[str]) -> str:
    """Non Maleficence Medical Ethics Tool
