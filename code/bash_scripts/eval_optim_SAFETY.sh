...
#SBATCH --job-name=SAFETY_evaloptim_GPT4o
...
#SBATCH --mem=8G         # How much RAM do you need?
...
for f in $(ls ../../benchmarks/safety/*); do
    echo "Running benchmark for dataset: $f"
    name="$(basename "$f" .json)"
    python ../eval_optimizer.py gpt-4o-2024-08-06 $name 1.0 evaloptimizer_gpt4o ../../out
done
